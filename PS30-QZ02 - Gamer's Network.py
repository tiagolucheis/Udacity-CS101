...
def create_data_structure(string_input):
    ...
    network = {} # each user has a list of connected users and liked games
    ...
    for sentence in sentences:
        ...
        if sentence:
            ...
            if "is connected to" in sentence:
                ...
                people = sentence[sentence.find('to')+3:]
                
                for person in people.split(','):
                    
                    network[user]['connections'].append(person.lstrip())
                    
            else:
                
                network[user]['games'] = []
                games = sentence[sentence.find('play')+5:]
                
                for game in games.split(','):
                    
                    network[user]['games'].append(game.lstrip())
